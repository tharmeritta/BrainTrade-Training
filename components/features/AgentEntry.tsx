...
export default function AgentEntry({ onAgentSelected }: AgentEntryProps) {
  ...
  return (
    ...
    >
      {/* ─── Shared background layer (spans full width) ─────────────── */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        />
        {/* Center bridge orb — sits right at the column seam */}
        ...
        {/* Soft vertical seam — glowing line instead of hard border */}
      ...
      >
          ...
          <div className="flex gap-3">
            {STATS_CONFIG.map((s, i) => (
              <motion.div
                ...
                className="flex flex-col py-4 px-5 rounded-2xl"
                style={{
        ...
        >
          <p className="text-[9px] font-semibold uppercase tracking-[0.18em] mb-2.5" style={{ color: 'var(--hub-dim)' }}>
            หลักสูตรทั้งหมด
          </p>
      ...
      {/* ─── RIGHT PANEL: Login ───────────────────────────────────────── */}
      <div
        className="relative flex items-center justify-center w-full lg:w-[420px] xl:w-[460px] shrink-0 px-6 py-10 overflow-y-auto"
        style={{ background: 'transparent' }}
      >
        ...
        >
          ...
          {/* Card */}
          <div style={{
            background: `linear-gradient(135deg, rgba(0,180,216,0.35), rgba(124,58,237,0.28), rgba(0,180,216,0.18))`,
            borderRadius: 25,
            padding: 1,
            boxShadow: '0 24px 64px rgba(0,0,0,0.15), 0 0 0 1px rgba(255,255,255,0.03)',
          }}>
            <div style={{
              ...
              <div style={{ padding: '28px 28px 28px' }}>
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-base font-black leading-tight" style={{ color: 'var(--hub-text)' }}>
                      ยินดีต้อนรับ
                    </h2>
                    <p className="text-xs" style={{ color: 'var(--hub-muted)' }}>
                      กรอกชื่อเพื่อเข้าสู่ระบบฝึกอบรม
                    </p>
                  </div>
                </div>
