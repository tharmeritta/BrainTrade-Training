...
export default function TrainerPanel({ role, uid, name, readOnly }: TrainerPanelProps) {
  ...
  return (
    <div className="flex flex-col gap-6" style={{ minHeight: 'calc(100dvh - 160px)' }}>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-border/50 pb-4">
        ...
        <div
          ...
          className="flex items-center rounded-2xl bg-secondary/40 p-1.5 border border-border/60 shadow-inner"
        >
          <button
            id="tab-wave"
            role="tab"
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-black transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${
              subDomain === 'wave'
